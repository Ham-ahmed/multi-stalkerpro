...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/multi-stalkerpro/main/multi-stalkerpro-py3.12_v1.0_all.tar.gz"
wait
tar -xzf multi-stalkerpro-py3.12_v1.0_all.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/multi-stalkerpro-py3.12_v1.0_all.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
