...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/multi-stalkerpro/main/multi-stalkerpro_1.0_py-3.12_arm.tar.gz"
wait
tar -xzf multi-stalkerpro_1.0_py-3.12_arm.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/multi-stalkerpro_1.0_py-3.12_arm.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
